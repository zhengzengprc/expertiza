Feature: View scores for an assignment
  ...
  Scenario: Instructor can view scores of an assignment
    Given "Dr Gehringer" logs into the system             # NB: Dr Gehringer is an instructor
      ...
      And user "mtreece" is a participant of "foo"        # NB: mtreece is a student
      And user "mtreece" scored 94 on assignment "foo"
      And user "sjain2" is a participant of "foo"         # NB: sjain2 is a student
      And user "sjain2" scored 96 on assignment "foo"
      And user "nobody" is a participant of "foo"         # NB: nobody is a student
  ...
  Scenario: TA can view scores of an assignment
    Given "Titus" logs into the system                    # NB: Titus is a TA
      ...
      And user "mtreece" is a participant of "bar"        # NB: mtreece is a student
      And user "mtreece" scored 84 on assignment "bar"
      And user "sjain2" is a participant of "bar"         # NB: sjain2 is a student
      And user "sjain2" scored 86 on assignment "bar"
      And user "nobody" is a participant of "bar"         # NB: nobody is a student
