require 'firewatir'
#require '/home/mtreece/expertiza/features/step_definitions/constants.rb'

#Capybara.app = "make sure this isn't nil" 

#When /"([\w[\d\w]+])" logs on through the logon page/ do |user_name|
When /\b"(\w+)"\b logs on through the logon page/ do |user_name|
...
Given /"([^"]*)" logs into the system/ do |user_name|
@logon_path = "http://localhost:3000/"
  ff=FireWatir::Firefox.new
  #logon 
  visit(@logon_path)
  fill_in( "User Name", :with => user_name )
