...
Given /^will create an assignment named "([^"]*)"$/ do |assignment_name|
...
When /^user adds "([^"]*)" to the assignment, "([^"]*)"/ do |arg1, arg2|
  pending # express the regexp above with the code you wish you had
end
...
Given /^will create a course named "([^"]*)"$/ do |arg1|
  pending # express the regexp above with the code you wish you had
end

Then /^the course named "([^"]*)" will exists$/ do |arg1|
  pending # express the regexp above with the code you wish you had
end
